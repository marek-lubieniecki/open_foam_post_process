...
class ForcesFileSubsonic(ForcesFile):
    def __init__(self, file_directory):
        super().__init__(file_directory)
        self.filepath = self.file_directory + '/0/forces.dat'
        self.load_forces()
    def load_forces(self):
...
class ForcesFilesSupersonic(ForcesFile):
    def __init__(self, file_directory):
        super().__init__(file_directory)
        self.force_filepath = file_directory + '/force.dat'
        self.torque_filepath = file_directory + '/moment.dat'
